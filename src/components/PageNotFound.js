...
const PageNotFound = ({ message,messageTitle }) => {
        ...
        <div className="container principal">
          <div className="row">
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"
                  ...
                  <g className="spaceman" clipPathh="url(cordClip)">
                    <path
                      id="cord"
                      fill="none"
                      stroke="#0E0620"
            ...
            <div className="col-md-6 align-self-center">
              <h1 className="text404">{messageTitle}</h1>
              <h2>{message}</h2>
            </div>
          </div>
        </div>
